...
2. [Install Slovak Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Slovak language pack](#3-how-to-active-hungarian-language-pack)
...
```
unzip master.zip app/i18n/Mageplaza/sk_sk
```
...
## 3. How to active Slovak language pack {#active}
