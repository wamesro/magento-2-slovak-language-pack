# How to contribute Slovak Language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-slovak-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [sk_SK.csv](https://github.com/mageplaza/magento-2-slovak-language-pack/blob/master/sk_SK.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-slovak-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `sk_SK.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `sk_SK.csv`, we will not approve it in this case.
...
You can [install this language package via composer](https://github.com/mageplaza/magento-2-slovak-language-pack#-method-1-composer-method-recommend) and other people can install / contribute this language pack.
